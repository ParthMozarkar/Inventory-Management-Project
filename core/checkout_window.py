...
class checkoutWindowClass:
    def __init__(self, parent, back_cmd):
        ...
        tk.Button(footer, text="FINALIZE SALE", font=("Helvetica", 11, "bold"), 
    ...
    def add(self):
        ...
        try:
            ...
            if stock < q:
                self.msg(f"❌ Shortage: Only {stock} bottles", "#f43f5e")
                return
        ...
        if messagebox.askyesno("Confirm", "Process Payment & Finalize?"):
            try:
                ...
                for child in self.tree.get_children():
                    ...
                    # Update Stock
                    cur.execute("UPDATE inventory SET quantity = quantity - ? WHERE barcode = ?", (v[5], v[1]))
